...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit1 }\OtherTok{\textless{}{-}}\NormalTok{ PM\_fit}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(model, data)}
\NormalTok{fit1}\SpecialCharTok{$}\FunctionTok{run}\NormalTok{(options)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sim1 }\OtherTok{\textless{}{-}}\NormalTok{ PM\_result}\SpecialCharTok{$}\FunctionTok{sim}\NormalTok{(...)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res1 }\OtherTok{\textless{}{-}} \FunctionTok{PM\_load}\NormalTok{(}\DecValTok{1}\NormalTok{)}
\NormalTok{res1}\SpecialCharTok{$}\NormalTok{op}\SpecialCharTok{$}\FunctionTok{plot}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sim1 }\OtherTok{\textless{}{-}}\NormalTok{ PM\_sim}\SpecialCharTok{$}\FunctionTok{load}\NormalTok{(}\StringTok{"sim.rds"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{data1 }\OtherTok{\textless{}{-}}\NormalTok{ PM\_data}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(}\StringTok{"data.csv"}\NormalTok{)}
\NormalTok{mod1 }\OtherTok{\textless{}{-}}\NormalTok{ PM\_model}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(}\StringTok{"model.txt"}\NormalTok{)}
\NormalTok{fit1 }\OtherTok{\textless{}{-}}\NormalTok{ PM\_fit}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(data1, mod1)}
\NormalTok{fit1}\SpecialCharTok{$}\FunctionTok{run}\NormalTok{()}
\NormalTok{res1 }\OtherTok{\textless{}{-}} \FunctionTok{PM\_load}\NormalTok{(}\DecValTok{1}\NormalTok{) }\CommentTok{\#PM\_load is an alias for PM\_result$new()}

\CommentTok{\#Run 2 {-} update Ke range}
\NormalTok{mod2 }\OtherTok{\textless{}{-}}\NormalTok{ mod1}\SpecialCharTok{$}\FunctionTok{update}\NormalTok{(}\FunctionTok{list}\NormalTok{(}\AttributeTok{pri =} \FunctionTok{list}\NormalTok{(}\AttributeTok{Ke =} \FunctionTok{range}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\DecValTok{3}\NormalTok{))))}
\NormalTok{fit2 }\OtherTok{\textless{}{-}}\NormalTok{ PM\_fit}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(data1, mod2)}
\NormalTok{fit2}\SpecialCharTok{$}\FunctionTok{run}\NormalTok{()}

\CommentTok{\#Run 3 {-} continue run 2}
\NormalTok{fit2}\SpecialCharTok{$}\FunctionTok{run}\NormalTok{(}\AttributeTok{prior =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#ensure that data.csv is in the working directory}
\NormalTok{data1 }\OtherTok{\textless{}{-}}\NormalTok{ PM\_data}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(}\StringTok{"data.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#assume df is data frame with at least these columns:}
\CommentTok{\#id, time, dose, out}
\NormalTok{data1 }\OtherTok{\textless{}{-}}\NormalTok{ PM\_data}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(df)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod }\OtherTok{\textless{}{-}}\NormalTok{ PM\_model}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(}\FunctionTok{list}\NormalTok{(}
...
\NormalTok{mod }\OtherTok{\textless{}{-}}\NormalTok{ PM\_model}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(}\FunctionTok{list}\NormalTok{(}
  \AttributeTok{pri =} \FunctionTok{list}\NormalTok{(...),}
  \AttributeTok{cov =} \FunctionTok{list}\NormalTok{(}\StringTok{"wt"}\NormalTok{,}\StringTok{"age"}\NormalTok{)}
\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{mod }\OtherTok{\textless{}{-}}\NormalTok{ PM\_model}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(}\FunctionTok{list}\NormalTok{(}
  \AttributeTok{pri =} \AttributeTok{pri =} \FunctionTok{list}\NormalTok{(}
    \AttributeTok{CL0 =} \FunctionTok{range}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{5}\NormalTok{),}
    \AttributeTok{V0 =} \FunctionTok{msd}\NormalTok{(}\DecValTok{10}\NormalTok{,}\DecValTok{3}\NormalTok{),}
    \AttributeTok{eff =} \FunctionTok{range}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{,}\AttributeTok{gtz=}\NormalTok{F)}
\NormalTok{  ),}
  \AttributeTok{cov =} \FunctionTok{list}\NormalTok{(}\StringTok{"wt"}\NormalTok{,}\StringTok{"age"}\NormalTok{),}
  \AttributeTok{sec =} \FunctionTok{list}\NormalTok{(}
    \AttributeTok{V =} \StringTok{"V0*wt"}\NormalTok{,}
    \StringTok{"\&IF(age \textgreater{}18) V = V0 * 75"}\NormalTok{,}
    \AttributeTok{CL =} \StringTok{"CL0 * wt"}
\NormalTok{  )}
\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{mod }\OtherTok{\textless{}{-}}\NormalTok{ PM\_model}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(}\FunctionTok{list}\NormalTok{(}
  \AttributeTok{bol =} \FunctionTok{list}\NormalTok{(}\StringTok{"NBCOMP(1) = 2"}\NormalTok{)}
\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  ),}
  \AttributeTok{cov =} \FunctionTok{list}\NormalTok{(}\StringTok{"wt"}\NormalTok{,}\StringTok{"age"}\NormalTok{,}\StringTok{"IC2"}\NormalTok{),}
  \AttributeTok{ini =} \FunctionTok{list}\NormalTok{(}
    \AttributeTok{X2 =} \StringTok{"IC2*V"}\NormalTok{,}
    \AttributeTok{X3 =} \StringTok{"IC3"}
\NormalTok{  )}
\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  ),}
  \AttributeTok{fa =} \FunctionTok{list}\NormalTok{(}
    \AttributeTok{fa1 =} \StringTok{"FA1"}
\NormalTok{  )}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  ),}
  \AttributeTok{lag =} \FunctionTok{list}\NormalTok{(}\AttributeTok{tlag1 =} \StringTok{"lag1"}\NormalTok{)}
\NormalTok{  )}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{mod2 }\OtherTok{\textless{}{-}}\NormalTok{ PM\_model}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(}\FunctionTok{list}\NormalTok{(}
  \AttributeTok{pri =} \AttributeTok{pri =} \FunctionTok{list}\NormalTok{(}
    ...
    \AttributeTok{V =} \FunctionTok{msd}\NormalTok{(}\DecValTok{100}\NormalTok{,}\DecValTok{30}\NormalTok{),}
\NormalTok{  ),}
  \AttributeTok{sec =} \FunctionTok{list}\NormalTok{(}\StringTok{"RES = B(1) * KIN/(KIN{-}KOUT) * (EXP({-}KOUT*TPD){-}EXP({-}KIN*TPD))"}\NormalTok{),}
  \AttributeTok{out =} \FunctionTok{list}\NormalTok{(}
    \AttributeTok{y1 =} \FunctionTok{list}\NormalTok{(}
...
\NormalTok{fit1 }\OtherTok{\textless{}{-}}\NormalTok{ PM\_fit}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(}\AttributeTok{data =} \StringTok{"data.csv"}\NormalTok{, }\AttributeTok{model =}\NormalTok{ mod1)}
...
\NormalTok{fit2 }\OtherTok{\textless{}{-}}\NormalTok{ PM\_fit}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(}\AttributeTok{data =}\NormalTok{ PMdata, }\AttributeTok{model =} \StringTok{"model.txt"}\NormalTok{)}

\CommentTok{\#Example 3 {-} data and model objects}
\NormalTok{fit3 }\OtherTok{\textless{}{-}}\NormalTok{ PM\_fit}\SpecialCharTok{$}\FunctionTok{new}\NormalTok{(PMdata, mod1)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{fit3}\SpecialCharTok{$}\FunctionTok{run}\NormalTok{(}\AttributeTok{engine =} \StringTok{"IT2B"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{res1}\SpecialCharTok{$}

\ErrorTok{**}\NormalTok{Objects loaded by }\FunctionTok{PMload}\NormalTok{(run\textbackslash{}\_num)}\SpecialCharTok{**}
\end{Highlighting}
\end{Shaded}
