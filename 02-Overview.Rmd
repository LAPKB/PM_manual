...
```{r echo=T, eval=FALSE}
sim1 <- PM_result$sim(...)
sim1 <- PM_sim$new(...) #these are equivalent
```
...
It is short
for `PM_result$load(1)`, which also works in the same way.
...
Similarly, `PM_fit`, `PM_sim`, `PM_valid`, and 
