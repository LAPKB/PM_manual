...
in R. See `?PM_model` for help on this object class. Blocks in the legacy model.txt files which were delimited with the "#" character become lists or character vectors in R6.

The R6 model components are:

* [PRImary](#priR6) (list)
* [COVariate](#covR6) (character vector)
* [SECondary](#secR6) (character vector)
* [BOLus](#bolR6) (character vector)
* [INItial conditions](#iniR6) (character vector)
* [F (bioavailability)](#FaR6) (character vector)
* [LAG time](#lagR6) (character vector)
* [DIFferential equations](#diffR6) (list)
* [OUTputs](#outR6) (list)
